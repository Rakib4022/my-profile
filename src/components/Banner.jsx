...
const Banner = () => {
    return (
        <div id='home' className='lg:flex space-y-10 pt-10 mb-10 p-4'>
            <div className='flex gap-4 justify-center items-center lg:w-1/2'>
            ...
            <div className='lg:w-1/2'>
                <Image src={rakib} alt='image' className='object-cover rounded-2xl' />
            </div>
        </div>
    );
};
